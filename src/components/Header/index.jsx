            ...
            <div className={cx("header-left")}>
                ...
                <div className={cx("header-search-group")}>
                    <div
                        ...
                        ref={suggestRef}
                    >
                        <h3 className={cx("header-suggest-title")}>
                            Suggest to you
                        </h3>
                        <ul className={cx("header-suggest-box")}>
                            ...
                            >
                                ...
                                <span className={cx("header-suggest-text")}>
                                    anh
                                </span>
                            </li>
                            <li

            ...
            <div className="mv-filter">
                ...
                >
                    ...
                    >
                        ...
                        <li className="mv-filter-items">
                            Nhạc Thiền (Meditation)
                        </li>
                    ...
                    <div className="mv-select d-flex align-items-center">
                        ...
                        <span className="mv-select-title">All</span>
                        <div className="mv-select-icon">
                ...
                <div
                    className="btn"
                    onClick={() => setIsShowOption2(!isShowOption2)}
                >
                    <ul
                        className={`mv-filter-options small ${
                            isShowOption2 ? "show" : ""
                        }`}
                    >
                        <li className="mv-filter-items">Listen a lot</li>
                        <li className="mv-filter-items">Outstanding</li>
                        <li className="mv-filter-items">Latest</li>
                    </ul>
                    <div className="mv-select d-flex align-items-center">
                        <div className="mv-select-icon">
                            <BiSortDown />
                        </div>
                        <span className="mv-select-title">Listen a lot</span>
                        <div className="mv-select-icon">
                            {isShowOption2 ? (
                                <BsChevronUp />
                            ) : (
